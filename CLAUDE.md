...
## n8n Workflow Instructions (LEGACY)

> **CRITICAL NOTICE:** The project has migrated away from n8n. All active automations are now Serverless Python scripts running on Modal.com (see `automations/AUTOMATIONS.md`). 
> The following n8n instructions are preserved entirely for reference and legacy maintenance of the `.json` files in `workflows/`. Do not use n8n for new features.

You are an expert in n8n automation software using n8n-MCP tools. Your role is to understand legacy workflows.
